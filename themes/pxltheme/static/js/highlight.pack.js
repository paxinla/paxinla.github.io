...
;return n.name="C",n.aliases=["c","h"],n}})());hljs.registerLanguage("accesslog",(()=>{"use strict";return e=>{
...
},e.HASH_COMMENT_MODE,e.QUOTE_STRING_MODE,e.NUMBER_MODE]})})());hljs.registerLanguage("protobuf",(()=>{"use strict";return e=>({
...
end:"`",contains:[{begin:/\\./}]}]}}})());hljs.registerLanguage("css",(()=>{"use strict";return e=>{
...
},e.C_BLOCK_COMMENT_MODE,t,e.HASH_COMMENT_MODE]}}})());hljs.registerLanguage("aspectj",(()=>{"use strict";return e=>{
...
className:"meta",begin:"@[A-Za-z]+"}]}}})());hljs.registerLanguage("go",(()=>{"use strict";return e=>{const n={
...
}],a.contains=n.contains,n}})());hljs.registerLanguage("latex",(()=>{"use strict";return e=>{const n=[{
...
excludeBegin:!0,end:a+":",relevance:0}],illegal:/#|<\//};var l}})());hljs.registerLanguage("asciidoc",(()=>{"use strict";return e=>({name:"AsciiDoc",
...
contains:[l,e.SHEBANG(),s,b,g,o,v,m,c]}}})());hljs.registerLanguage("python",(()=>{"use strict";return e=>{const n={
...
illegal:/\S/,contains:[f,i,m,p,c,u,l,o,d]}}})());hljs.registerLanguage("dts",(()=>{"use strict";return e=>{const n={
...
begin:e.IDENT_RE+"::",keywords:""}]}}})());hljs.registerLanguage("excel",(()=>{"use strict";return E=>({
...
starts:{end:/[^\\]$/,subLanguage:"bash"}}],illegal:"</"})})());hljs.registerLanguage("clojure-repl",(()=>{"use strict";return e=>({
name:"Clojure REPL",contains:[{className:"meta",begin:/^([\w.-]+|\s*#_)?=>/,
starts:{end:/$/,subLanguage:"clojure"}}]})})());hljs.registerLanguage("python-repl",(()=>{"use strict";return s=>({
...
aliases:["pl","pm"],keywords:s,contains:c}}})());hljs.registerLanguage("erlang",(()=>{"use strict";return e=>{
...
},contains:[u]},s,e.QUOTE_STRING_MODE,b,o,l,d,{begin:/\.$/}]}}})());hljs.registerLanguage("cpp",(()=>{"use strict";function e(e){
return((...e)=>e.map((e=>(e=>e?"string"==typeof e?e:e.source:null)(e))).join(""))("(",e,")?")
}return t=>{const n=(t=>{const n=t.COMMENT("//","$",{contains:[{begin:/\\\n/}]
}),r="[a-zA-Z_]\\w*::",a="(decltype\\(auto\\)|"+e(r)+"[a-zA-Z_]\\w*"+e("<[^<>]+>")+")",s={
className:"keyword",begin:"\\b[a-z\\d_]*_t\\b"},i={className:"string",
...
n.aliases=["cc","c++","h++","hpp","hh","hxx","cxx"],n}})());hljs.registerLanguage("gradle",(()=>{"use strict";return e=>({name:"Gradle",
...
className:"meta",begin:/^\s*\.[\w_-]+/}]})})());hljs.registerLanguage("shell",(()=>{"use strict";return s=>({
...
name:"Plain text",aliases:["text","txt"],disableAutodetect:!0})})());hljs.registerLanguage("autohotkey",(()=>{"use strict";return e=>{const a={
...
begin:"A_[a-zA-Z0-9]+"},{begin:",\\s*,"}]}}})());hljs.registerLanguage("kotlin",(()=>{"use strict"
...
className:"symbol",begin:/<[\w-]+>/}]})})());hljs.registerLanguage("julia-repl",(()=>{"use strict";return a=>({
name:"Julia REPL",contains:[{className:"meta",begin:/^julia>/,relevance:10,
starts:{end:/^(?![ ]{6})/,subLanguage:"julia"},aliases:["jldoctest"]}]})})());hljs.registerLanguage("java",(()=>{"use strict"
;var e="\\.([0-9](_*[0-9])*)",n="[0-9a-fA-F](_*[0-9a-fA-F])*",a={
className:"number",variants:[{
begin:`(\\b([0-9](_*[0-9])*)((${e})|\\.)?|(${e}))[eE][+-]?([0-9](_*[0-9])*)[fFdD]?\\b`
},{begin:`\\b([0-9](_*[0-9])*)((${e})[fFdD]?\\b|\\.([fFdD]\\b)?)`},{
...
begin:"@[a-zA-Z_][a-zA-Z_\\d]*"}]}}})());hljs.registerLanguage("elm",(()=>{"use strict";return e=>{const n={
variants:[e.COMMENT("--","$"),e.COMMENT(/\{-/,/-\}/,{contains:["self"]})]},i={
...
begin:"^[_a-z][\\w']*"}),n,{begin:"->|<-"}],illegal:/;/}}})());hljs.registerLanguage("thrift",(()=>{"use strict";return e=>{
...
contains:["self"]}]}}})());hljs.registerLanguage("coffeescript",(()=>{"use strict"
